...
const CheckInScreen = () => {
	...
	// const updateUserPoints = (itemValue) => {
	// 	console.log('update user');
	// 	dispatch(addUserPoints(150));
	// };
	...
	// 					<div className="stat-item__value">{user.points}</div>

	// 					<div className="stat-item__description">Total Points</div>
	// 				</div>
	// 				<div className="stat-item">
	// 					<div className="stat-item__value">{user.visits.length}</div>
	// 					<div className="stat-item__description">Visits</div>
	// 				</div>
	// 				<div className="stat-item">
	// 					<div className="stat-item__value">{user.redemptions.length}</div>
	// 					<div className="stat-item__description">Redemptions</div>
	// 				</div>
	// 			</div>
	// )

	const checkInSuccessContent = (
		<div className="check-in-success">
			<div className="success__header">
				<div className="icon-wrapper">{celebrate}</div>
				<h1>Points Earned!</h1>

				<p>Thanks for stopping in. You may redeem your points at any time.</p>
			</div>
	...
	const checkInFailContent = (
		<div className="check-in-success">
			<div className="success__header">
				<div className="icon-wrapper">{celebrate}</div>
				<h1>Need To Wait More Time!</h1>
	...
	React.useEffect(() => {
		console.log('old use points');
		// updatePointsHandler();
	}, []);
	return (
		<Screen id="check-in" title="Thanks For Checking In!">
			{isEnoughTimePassed ? checkInSuccessContent :checkInFailContent}
		</Screen>
	);
};
